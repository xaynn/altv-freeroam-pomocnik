...
let prop = null;
const menu = new NativeUI.Menu("Animacje", "", new NativeUI.Point(50, 50));
...
let menuDanceItem = new NativeUI.UIMenuItem("Tance", "Wszystkie dostępne tańce.");
menu.AddItem(menuDanceItem);

const DanceMenu = new NativeUI.Menu("Tance", "Taniec:", new NativeUI.Point(50, 50));
...
AvailableDances.forEach(element => {
	let DanceItem = new NativeUI.UIMenuItem(element.name, "Wszystkie dostępne tańce.");
	DanceMenu.AddItem(DanceItem);
});

let menuAniamtionItem = new NativeUI.UIMenuItem("Animacje", "Wszystkie dostępne animacje.");
menu.AddItem(menuAniamtionItem);

const AnimationMenu = new NativeUI.Menu("Animacje", "Animacja:", new NativeUI.Point(50, 50));
...
AvailableAnimations.forEach(element => {
	let DanceItem = new NativeUI.UIMenuItem(element.name, "Wszystkie dostępne animacje.");
